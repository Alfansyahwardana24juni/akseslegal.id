...
const allServices = [
    { id: 1, name: "PT Perorangan", price: "Rp 999.000", category: "usaha", icon: "person", color: "primary", link: "layanan-pt.html" },
    { id: 2, name: "Upgrade ke PT Umum", price: "Rp 4.500.000", category: "usaha", icon: "upgrade", color: "primary" },
    { id: 3, name: "CV", price: "Rp 1.999.000", category: "usaha", icon: "groups", color: "secondary", link: "layanan-cv.html" },
    { id: 4, name: "RUPS CV (Perubahan)", price: "Rp 1.999.000", category: "usaha", icon: "edit_document", color: "secondary" },
    { id: 5, name: "PT Umum", price: "Rp 3.999.000", category: "usaha", icon: "corporate_fare", color: "primary", link: "layanan-pt-umum.html" },
    ...
    { id: 22, name: "Merek", price: "Rp 1.899.000", category: "haki", icon: "verified_user", color: "green", link: "layanan-haki.html" },
    { id: 23, name: "Merek (+ Surat Sanggahan)", price: "Rp 2.999.000", category: "haki", icon: "gavel", color: "green" },
    { id: 24, name: "Merek (+ Sanggahan & Refund 100%)", price: "Rp 4.500.000", category: "haki", icon: "verified", color: "green" },
    { id: 25, name: "Merek (+ Sanggahan, Banding & Refund)", price: "Rp 7.500.000", category: "haki", icon: "shield", color: "green" },
    { id: 26, name: "Tambahan Sub Kelas Merek", price: "Rp 1.500.000", category: "haki", icon: "add_circle", color: "green" },
    { id: 27, name: "PIRT", price: "Rp 399.000", category: "sektoral", icon: "restaurant", color: "orange" },
    { id: 28, name: "Halal - PIRT", price: "Rp 999.000", category: "sektoral", icon: "verified", color: "red", link: "layanan-halal.html" },
    ...
    { id: 31, name: "BPOM", price: "Rp 9.499.000", category: "sektoral", icon: "health_and_safety", color: "blue" },
    { id: 32, name: "SBU Konstruksi + KTA Asosiasi", price: "Rp 2.999.000", category: "sektoral", icon: "construction", color: "yellow" },
    { id: 33, name: "E-Catalogue", price: "Rp 2.500.000", category: "sektoral", icon: "shopping_cart", color: "indigo" },
    { id: 34, name: "Sewa Tenaga S1 Teknik Sipil", price: "Rp 9.000.000", category: "sektoral", icon: "engineering", color: "gray" },
    { id: 35, name: "Sewa Tenaga SMA", price: "Rp 7.500.000", category: "sektoral", icon: "school", color: "gray" },
    { id: 36, name: "Biaya Ujian Tenaga Ahli S1", price: "Rp 4.000.000", category: "sektoral", icon: "quiz", color: "blue" },
    { id: 37, name: "Biaya Ujian Tenaga Terampil SMA", price: "Rp 2.500.000", category: "sektoral", icon: "assignment", color: "blue" },
    { id: 38, name: "ISO 9001", price: "Rp 12.000.000", category: "sektoral", icon: "workspace_premium", color: "gold" },
    { id: 39, name: "ISO 14001", price: "Rp 12.000.000", category: "sektoral", icon: "eco", color: "green" },
    { id: 40, name: "ISO 45001", price: "Rp 12.000.000", category: "sektoral", icon: "health_and_safety", color: "red" },
    { id: 41, name: "TKDN", price: "Rp 7.500.000", category: "sektoral", icon: "flag", color: "red" },
    { id: 42, name: "SNI", price: "Rp 15.000.000", category: "sektoral", icon: "verified", color: "blue" },
    { id: 43, name: "Sertifikat Laik Fungsi (SLF)", price: "Rp 5.000.000", category: "sektoral", icon: "apartment", color: "gray" },
    { id: 44, name: "PBG (Persetujuan Bangunan Gedung)", price: "Rp 3.500.000", category: "sektoral", icon: "domain", color: "brown" },
    { id: 45, name: "IPAL", price: "Rp 8.000.000", category: "sektoral", icon: "water_drop", color: "blue" },
    { id: 46, name: "AMDAL", price: "Rp 25.000.000", category: "sektoral", icon: "nature", color: "green" },
    { id: 47, name: "UKL-UPL", price: "Rp 7.500.000", category: "sektoral", icon: "eco", color: "green" },
    { id: 48, name: "SPPL", price: "Rp 2.500.000", category: "sektoral", icon: "description", color: "green" },
    { id: 49, name: "Izin Lingkungan", price: "Rp 10.000.000", category: "sektoral", icon: "park", color: "green" },
    { id: 50, name: "Izin Usaha Pertambangan (IUP)", price: "Rp 50.000.000", category: "sektoral", icon: "landscape", color: "brown" },
    { id: 51, name: "SIUP-MB", price: "Rp 5.000.000", category: "sektoral", icon: "inventory", color: "orange" },
    { id: 52, name: "API (Angka Pengenal Impor)", price: "Rp 7.500.000", category: "sektoral", icon: "local_shipping", color: "blue" },
    { id: 53, name: "NPIK (Nomor Pokok Importir Khusus)", price: "Rp 5.000.000", category: "sektoral", icon: "import_export", color: "indigo" },
    { id: 54, name: "Izin Edar Kosmetik", price: "Rp 5.500.000", category: "sektoral", icon: "face", color: "pink" },
    { id: 55, name: "Izin Edar Alat Kesehatan", price: "Rp 8.000.000", category: "sektoral", icon: "medical_services", color: "red" },
    { id: 56, name: "Izin Edar Obat Tradisional", price: "Rp 6.500.000", category: "sektoral", icon: "medication", color: "green" },
    { id: 57, name: "Izin Edar Suplemen", price: "Rp 5.000.000", category: "sektoral", icon: "vaccines", color: "blue" },
    ...
    { id: 61, name: "Izin Usaha Industri", price: "Rp 3.500.000", category: "sektoral", icon: "factory", color: "gray" },
    { id: 62, name: "Izin Usaha Jasa Konstruksi", price: "Rp 4.000.000", category: "sektoral", icon: "construction", color: "yellow" },
    ...
    { id: 65, name: "Izin Reklame", price: "Rp 1.000.000", category: "sektoral", icon: "campaign", color: "purple" },
    { id: 66, name: "Izin Usaha Pariwisata", price: "Rp 5.000.000", category: "sektoral", icon: "travel_explore", color: "blue" },
    { id: 67, name: "Izin Usaha Perhotelan", price: "Rp 7.500.000", category: "sektoral", icon: "hotel", color: "gold" },
    { id: 68, name: "Izin Usaha Restoran", price: "Rp 3.000.000", category: "sektoral", icon: "restaurant_menu", color: "red" },
    { id: 69, name: "Izin Usaha Kafe", price: "Rp 2.500.000", category: "sektoral", icon: "local_cafe", color: "brown" },
    { id: 70, name: "Izin Usaha Toko Retail", price: "Rp 2.000.000", category: "usaha", icon: "shopping_bag", color: "green" },
    { id: 71, name: "Izin Usaha Apotek", price: "Rp 10.000.000", category: "sektoral", icon: "local_pharmacy", color: "green" },
    { id: 72, name: "Izin Usaha Klinik", price: "Rp 15.000.000", category: "sektoral", icon: "local_hospital", color: "red" },
    { id: 73, name: "Izin Usaha Laboratorium", price: "Rp 12.000.000", category: "sektoral", icon: "science", color: "blue" },
...
function renderServiceCards(services) {
    ...
    grid.innerHTML = services.map(service => {
        ...
        const href = service.link || `detaillayanan.html?id=${service.id}`;
